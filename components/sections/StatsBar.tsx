  ...
  return (
    <section className="w-full bg-white py-[80px]">
      <div className="max-w-[1240px] mx-auto px-6 flex flex-col md:flex-row items-start gap-10 md:gap-16">
        ...
        <ScrollReveal direction="left" className="md:max-w-[380px] flex flex-col gap-3 flex-shrink-0">
          <h2 className="text-black font-semibold text-[32px] sm:text-[40px] md:text-[50px] leading-[1.15] md:leading-[55px] font-sans">
        ...
        <div className="grid grid-cols-2 gap-4 flex-1">
          ...
          <div className="col-span-2 flex justify-center">
            <ScrollReveal delay={0.24} className="w-[calc(50%-8px)]">
