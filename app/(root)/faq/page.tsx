...
export default function FaqPage() {
  ...
  return (
    <main className="bg-white min-h-screen">
      {/* Hero */}
      <section className="w-full bg-white pt-[100px] pb-[60px] md:pt-[120px] md:pb-[80px]">
        <div className="max-w-[1280px] mx-auto px-6 flex flex-col items-center text-center gap-5">
          ...
          <h1 className="text-[#1b1b1b] font-medium font-sans text-[40px] md:text-[70px] leading-[1.2] md:leading-[84px] tracking-[-2px] md:tracking-[-3.5px] capitalize max-w-[775px]">
            Frequently Asked Questions
          </h1>
          <p className="text-[#343434] text-[16px] md:text-[18px] font-sans leading-[27px] tracking-[-0.6px] max-w-[600px]">
